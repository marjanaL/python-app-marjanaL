...
[![CI for Flask Product API](https://github.com/DevOps2-Fundamentals/python-app-marjanaL/actions/workflows/WF-first.yml/badge.svg)](https://github.com/DevOps2-Fundamentals/python-app-marjanaL/actions/workflows/WF-first.yml)
